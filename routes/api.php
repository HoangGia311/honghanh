...
Route::group(['middleware' => ['jwt.auth', 'log']], function () {
    ...
    Route::resource('posts', 'API\PostController', ['except' => [ 'show' ]]);
    Route::post('posts/{id}', 'API\PostController@update')->name('posts.update');
    Route::resource('gallery', 'API\GalleryController', ['except' => [ 'show' ]]);
    Route::post('gallery/{gallery}', 'API\GalleryController@update')->name('gallery.update');
    Route::resource('image', 'API\ImageController', ['except' => [ 'show' ]]);
    ...
    Route::resource('cooking', 'API\CookingController', ['except' => [ 'show' ]]);
