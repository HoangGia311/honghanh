    ...
    <div class="page">
        <div class="page-header">
            ...
            <div class="page-actions">
                <router-link class="button" :to="{ name : 'CreateCooking'}">
                    Add cooking
                </router-link>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        <template v-if="pagination.data.length">
                                            <tr v-for="(item , index) in pagination.data" :key="`index_${index}`">
                                                ...
                                                <td class="td-actions">
                                                    <router-link class="button secondary icon-edit" :to="{ name : 'EditCooking' , params : { id : item.id}}"></router-link>
...
export default {
    ...
    methods : {
        ...mapActions({
            fetchData : 'cooking/list',
            delete : 'cooking/delete'
        }),
        getList(route){
        ...
        remove(id){
            this.$confirm.show({
                title : 'Confirm',
                content : 'Do do want to delete this cooking ?',
                btnSave : 'Delete',
